...
<%
    ...
    consulta = "SELECT (CASE WHEN MONTH(fechaelaboleta)=1 THEN 'ENERO' "
            ...
            + " FROM boleta WHERE estado='POR CANCELAR' GROUP BY mes ";
        ...
        <div align="center">
            <form name="formBus" action="gasto_list_search.jsp" method="get">
                <table width="729" id="rounded-corner">
                    ...
                    <tr id="rounded-buscar">
                        <th class="rounded-foot-left" colspan="2" align="right">BOLETAS POR CANCELAR</th>

                        <th  class="rounded-foot-right" align="right" style="margin-left: 100px" colspan="2">

                            <a href="boleta_estadistica.jsp" title="Reporte Gral Factura"><img src="../imagenes/icons/home.png" height="45" width="45" alt=""/></a>&nbsp;
