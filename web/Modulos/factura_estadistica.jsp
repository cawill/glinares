            ...
            <form name="formBus" action="gasto_list_search.jsp" method="get">
                <table width="729" id="rounded-corner">
                    ...
                    <tr id="rounded-buscar">
                        ...
                        <a href="factura_estadistica_cancelado.jsp" title="Cancelados"><img src="../imagenes/icons/pago.png" style="margin-bottom: 4px" height="38" width="38" alt=""/></a>&nbsp;&nbsp;
                        <a href="factura_estadistica_porcancelar.jsp" title="Por Cancelar"><img src="../imagenes/icons/deben.png" style="margin-bottom: 4px" height="38" width="38" alt=""/></a>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </th>
                    </tr>
                </table>
