            ...
            if (request.getParameter("textoDeBusqueda") != null) {
                ...
                if (orden.equals("1")) {
                    ...
                    consulta = "select r.idRampla,r.tipo,r.ejes,r.placa,r.nroConstancia," +
                            ...
                            "on r.idCliente=t.idCliente where r.ejes like ? and r.idRampla";
                    ...
                    consulta = "select r.idRampla,r.tipo,r.ejes,r.placa,r.nroConstancia," +
                            "r.configuracion,r.clase,r.descripcion,r.estado,r.idCliente," +
                            "t.razonSocial from ramplas r inner join cliente t " +
                            "on r.idCliente=t.idCliente where r.placa like ? and r.idRampla";
                    ps = conex.prepareStatement(consulta);
                    ps.setString(1, "%"+request.getParameter("textoDeBusqueda")+"%");
                    rs = ps.executeQuery();
                    ...
                    consulta = "select r.idRampla,r.tipo,r.ejes,r.placa,r.nroConstancia," +
                            "r.configuracion,r.clase,r.descripcion,r.estado,r.idCliente," +
                            "t.razonSocial from ramplas r inner join cliente t " +
                            "on r.idCliente=t.idCliente where r.tipo like ? and r.idRampla";
                    ps = conex.prepareStatement(consulta);
                    ps.setString(1, "%"+request.getParameter("textoDeBusqueda")+"%");
                    rs = ps.executeQuery();
                    ...
                    consulta = "select r.idRampla,r.tipo,r.ejes,r.placa,r.nroConstancia," +
                            "r.configuracion,r.clase,r.descripcion,r.estado,r.idCliente," +
                            "t.razonSocial from ramplas r inner join cliente t " +
                            "on r.idCliente=t.idCliente where t.razonSocial like ? and r.idRampla";
                    ps = conex.prepareStatement(consulta);
                    ps.setString(1, "%"+request.getParameter("textoDeBusqueda")+"%");
                    rs = ps.executeQuery();
