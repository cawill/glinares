...
String idc="";
try{
String sql="select*from crt where idcrt='"+repcrt+"';";
ps = conex.prepareStatement(sql);
rs = ps.executeQuery();
while(rs.next()){
idc=rs.getString("idcrt");
}

/*ruta del reporte*/ 
File reportFile = new File(application.getRealPath("Modulos/reportes/Rcrt.jasper")); 
 
/*enviando parametros */
 
Map parameters = new HashMap(); 
parameters.put("rCrt", idc); 
