            ...
            if (request.getParameter("textoDeBusqueda") != null) {
                ...
                if (orden.equals("1")) {
                    consulta = "select tr.idTracto,tr.placa,tr.marca,tr.ejes,tr.modelo," +
                            ...
                            "on tr.idCliente=t.idCliente where tr.ejes like ? and tr.idTracto";
                    ...
                    consulta = "select tr.idTracto,tr.placa,tr.marca,tr.ejes,tr.modelo," +
                            ...
                            "tr.chasis,tr.estado,tr.idCliente," +
                            "t.razonSocial from tracto tr inner join cliente t " +
                            "on tr.idCliente=t.idCliente where tr.placa like ? and tr.idTracto";
                    ps = conex.prepareStatement(consulta);
                    ps.setString(1, "%" + request.getParameter("textoDeBusqueda") + "%");
                    rs = ps.executeQuery();
                    ...
                    consulta = "select tr.idTracto,tr.placa,tr.marca,tr.ejes,tr.modelo," +
                            ...
                            "tr.chasis,tr.estado,tr.idCliente," +
                            "t.razonSocial from tracto tr inner join cliente t " +
                            "on tr.idCliente=t.idCliente where tr.capacidad like ? and tr.idTracto";
                    ps = conex.prepareStatement(consulta);
                    ps.setString(1, "%" + request.getParameter("textoDeBusqueda") + "%");
                    rs = ps.executeQuery();
                    ...
                    consulta = "select tr.idTracto,tr.placa,tr.marca,tr.ejes,tr.modelo," +
                            ...
                            "tr.chasis,tr.estado,tr.idCliente," +
                            "t.razonSocial from tracto tr inner join cliente t " +
                            "on tr.idCliente=t.idCliente where t.razonSocial like ? and tr.idTracto";
                    ps = conex.prepareStatement(consulta);
                    ps.setString(1, "%" + request.getParameter("textoDeBusqueda") + "%");
                    rs = ps.executeQuery();
...
<html>
    ...
    <body>
        ...
        <table align="center" id="rounded-corner" border="0">
            <thead>
           <tr>
               <th colspan="7" class="rounded-company"></th>
