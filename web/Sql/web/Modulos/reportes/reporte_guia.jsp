...
String idc="";
try{
String sql="select*from guia_remision where idGuia='"+repguia+"';";
ps = conex.prepareStatement(sql);
rs = ps.executeQuery();
while(rs.next()){
idc=rs.getString("idGuia");
}

/*ruta del reporte*/ 
File reportFile = new File(application.getRealPath("Modulos/reportes/RepGuia.jasper")); 
 
/*enviando parametros */
 
Map parameters = new HashMap(); 
parameters.put("rGuia", idc); 
